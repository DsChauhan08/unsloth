...
class TrainingBackend:
    ...
    def start_training(self, job_id: str, **kwargs) -> bool:
        ...
        config = {
            ...
            "kaggle_timebomb_hours": kwargs.get("kaggle_timebomb_hours"),
            "kaggle_auto_vram": kwargs.get("kaggle_auto_vram", False),
            "kaggle_ghost_cache": kwargs.get("kaggle_ghost_cache", False),
